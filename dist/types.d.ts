...
export type ActionHandler = (args: Record<string, unknown>, ctx: ActionContext) => Promise<Record<string, unknown>>;
/**
 ...
 */
export type MockActionHandler = (args: Record<string, unknown>, ctx: MockActionContext) => Promise<Record<string, unknown>>;
...
export type AuthConfig = OAuthConfig | ApiKeyConfig | NoAuthConfig;
